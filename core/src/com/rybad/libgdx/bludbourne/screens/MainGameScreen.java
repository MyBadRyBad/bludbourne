package com.rybad.libgdx.bludbourne.screens;
...
import com.rybad.libgdx.bludbourne.Entity;
import com.rybad.libgdx.bludbourne.MapManager;
import com.rybad.libgdx.bludbourne.PlayerController;
...
public class MainGameScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        // lock and center the _camera to the player position
        _camera.position.set(_currentPlayerSprite.getX(), _currentPlayerSprite.getY(), 0f);
        _camera.update();

        _player.update(delta);
        _currentPlayerFrame = _player_getFrame();
    ...
    private void setupViewport(int width, int height) {
        ...
        // update viewport if the could be skewing
